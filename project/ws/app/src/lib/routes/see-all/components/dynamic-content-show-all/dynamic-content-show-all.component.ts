...
@Component({
  selector: 'ws-app-dynamic-content-show-all',
  templateUrl: './dynamic-content-show-all.component.html',
  styleUrls: ['./dynamic-content-show-all.component.scss']
})
export class DynamicContentShowAllComponent implements OnInit, OnDestroy {
  contentItems: any[] = []

...
import { DynamicContentShowAllComponent } from './dynamic-content-show-all.component'
import { SeeAllService } from '../../services/see-all.service'

describe('DynamicContentShowAllComponent', () => {
  let component: DynamicContentShowAllComponent
  let fixture: ComponentFixture<DynamicContentShowAllComponent>
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [DynamicContentShowAllComponent],
    ...
    fixture = TestBed.createComponent(DynamicContentShowAllComponent)

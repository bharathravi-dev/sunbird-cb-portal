...
@Component({
  selector: 'ws-discussion-tour-guide',
  templateUrl: './discussion-tour-guide.component.html',
  styleUrls: ['./discussion-tour-guide.component.scss'],

  providers: [UserProfileService],
})
export class DiscussionTourGuideComponent {
